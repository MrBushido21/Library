...
namespace eval supergrid {
    ...
    variable DiscardWidgets [list .#BWidget#frame .#BWidget#label .#BWidget#button \
		                .#BWidget#scrollbar .#BWidget#entry .#BWidget#listbox \
		                 .#BWidgetClass#DynamicHelp .#BWidgetClass#ScrolledWindow \
		                .#BWidgetClass#ButtonBox .#BWidgetClass#DragSite \
		                .#BWidgetClass#DropSite .#BWidgetClass#TitleFrame]
...
proc supergrid::go { f { isrecursive 0 } } {
	...
	if { [lsearch $DiscardWidgets $i] != -1 } { continue }
