...
namespace eval Pan {
    ...
    proc pan { action { w {} } { x {} } { y {} } } {
        ...
        switch $action {
            init {
				# initialize the pan icon (only called once)
                # Create pan icon
                ...
                # @@@ option add *Pan.Label.Background White widgetDefault
                # @@@ option add *Pan.Label.Relief groove widgetDefault
                # @@@ pack [label .pan.label -text "Panning..."]
