...
proc RamDebugger::Instrumenter::DoWorkForMarkdown { args } {
    variable FastInstrumenterLoaded
        
    set optional {
        { -svgml boolean 0 }
    }
    set compulsory "block blockinfoname"
    ...
    if { [info commands markdown_evaluate] ne "" } {
        set ret [markdown_evaluate {*}$svgmlCMD rdinfo $block]
        upvar 1 $blockinfoname blockinfo
        set blockinfo [split $ret \n]
    }
}
