...
proc MainFrame::_create_menubar { path descmenu } {
    ...
    # GiD changes to permmit to redefine the menus (for ramdebugger)
    #set menubar [eval [list menu $top.menubar -tearoff 0] $menuopts $mbfnt]
    #$top configure -menu $menubar
    
    # GiD: destroy old menus
...
proc MainFrame::_parse_accelerator { desc } {
	...
	ShiftCtrl {
	    # GiD
	    set accel "Shift+Ctrl+$upc"
	    set events [list "<Shift-Control-Key-$key>"]
	}
	Cmd {
	    set accel "Cmd+$upc"
