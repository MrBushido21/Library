...
proc load_BWidget { dir version } {
    package require Tk 8.1.1
    package provide BWidget $version
    tclPkgSetup $dir BWidgetR $version {
...
#BWidgetR is BWidget with some small modification of GiD (find the word 'GiD')
#modifications:
#mainframe.tcl :to be used by ramdebugger
#button.tcl : catch for non-latin encodings like Korean
#if ask for BWidgetR or BWidget provide the same (and set as provided both)
package ifneeded BWidgetR 1.9.13 [list load_BWidget $dir 1.9.13]
package ifneeded BWidget 1.9.13 [list load_BWidget $dir 1.9.13]
