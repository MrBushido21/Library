...
lappend ::dbInfo {Tcl 8.7a6 unix, Tk 8.7a6 x11}
set ::dbTclVersion 8.7
...
tk::startOfCluster
tk::startOfNextWord
tk::startOfPreviousWord
tk::sysnotify::_fade_in
tk::sysnotify::_fade_out
tk::sysnotify::_notifywindow
...
set ::syntax(tk::mc) {r 0}
set ::syntax(tk::mcmax) {r 0}
set ::syntax(tk::mcmaxamp) {r 0}
...
set ::syntax(tk::sysnotify::_fade_in) 1
set ::syntax(tk::sysnotify::_fade_out) 1
set ::syntax(tk::sysnotify::_notifywindow) 2
...
set ::syntax(tk::wordBreakAfter) {r 2 3}
set ::syntax(tk::wordBreakBefore) {r 2 3}
...
set ::subCmd(string) {bytelength cat compare equal first index insert is last length map match range repeat replace reverse tolower totitle toupper trim trimleft trimright wordend wordstart}
...
set ::option(fconfigure) {-blocking -buffering -buffersize -closemode -encoding -eofchar -error -handshake -inputmode -lasterror -mode -peername -pollinterval -queue -sockname -sysbuffer -timeout -translation -ttycontrol -ttystatus -winsize -xchar}
...
set ::option(oo::define::superclass) {-append -clear -prepend -remove -set}
set ::option(oo::define::variable) {-append -clear -prepend -remove -set}
...
set ::option(oo::objdefine::variable) {-append -clear -prepend -remove -set}
