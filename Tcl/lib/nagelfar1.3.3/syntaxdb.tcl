...
lappend ::dbInfo {Tcl 8.6.12 unix, Tk 8.6.12 x11}
...
set ::syntax(ttk::treeview::select.choose.browse) 2
set ::syntax(ttk::treeview::select.choose.extended) 2
set ::syntax(ttk::treeview::select.choose.none) 2
set ::syntax(ttk::treeview::select.extend.browse) 2
set ::syntax(ttk::treeview::select.extend.extended) 2
set ::syntax(ttk::treeview::select.extend.none) 2
set ::syntax(ttk::treeview::select.toggle.browse) 2
set ::syntax(ttk::treeview::select.toggle.extended) 2
set ::syntax(ttk::treeview::select.toggle.none) 2
...
set ::subCmd(_obj,ttk::combobox) {bbox cget configure current delete get icursor identify index insert instate selection set state validate xview}
...
set ::option(oo::define::superclass) {-append -clear -set}
set ::option(oo::define::variable) {-append -clear -set}
set ::option(oo::objdefine::filter) {-append -clear -set}
set ::option(oo::objdefine::mixin) {-append -clear -set}
set ::option(oo::objdefine::variable) {-append -clear -set}
